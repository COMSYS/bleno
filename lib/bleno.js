...
Bleno.prototype.startAdvertisingWithDict = function(advertisingDict, callback) {
    ...
    serviceUuids = advertisingDict['serviceUuids'];
    ...
    advertisingDict['serviceUuids'] = undashedServiceUuids;
    
    this._bindings.startAdvertisingWithDict(advertisingDict);
};
...
Bleno.prototype.startAdvertising = function(name, serviceUuids, callback) {
  ...
  if (serviceUuids && serviceUuids.length) {
    ...
    advertisingDict = {'name': name, 'serviceUuids': undashedServiceUuids};
