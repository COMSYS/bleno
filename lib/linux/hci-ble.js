...
HciBle.prototype.onSocketData = function(data) {
    console.log('DATA: ' + data);
    
    inputbuffer.fill(data, current_index, data.length);
    ...
    while(current_index >= HEADER_SIZE) {
        ...
        inputbuffer.fill(inputbuffer.slice(HEADER_SIZE+len), 0, inputbuffer.length-HEADER_SIZE-len);
