...
L2capBle.prototype.onStdoutData = function(data) {
  ...
  while ((newLineIndex = this._buffer.indexOf('\n')) !== -1) {
    ...
    }else if ((found = line.match(/^hciHandle (.*)$/))) {
...
L2capBle.prototype.setLatency = function(min,max,latency,to_multiplier) {
    ...
    this._l2capBle.stdin.write("latency" + buf.toString("hex") + '\n');
};
...
L2capBle.prototype.send = function(data) {
  debug('send: ' + data.toString('hex'));
  this._l2capBle.stdin.write("data" + data.toString('hex') + '\n');
};
...
L2capBle.prototype.handleFindInfoRequest = function(request) {
  var response = null;
...
L2capBle.prototype.handleFindByTypeRequest = function(request) {
  var response = null;
...
L2capBle.prototype.handleReadOrReadBlobRequest = function(request) {
  var response = null;
...
L2capBle.prototype.handleWriteRequestOrCommand = function(request) {
  var response = null;
